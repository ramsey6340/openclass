...
class Administrator extends UserModel
{
  Administrator(
      ...
      String? img_profile,
      String? password,
      String? date_birth}):super(id, email,first_name:first_name, last_name:last_name, tel_number:tel_number, img_profile:img_profile, password:password, date_birth:date_birth);
