...
{
  // les constructeurs
  Responsible(String id, String first_name, String last_name, String email, String tel_number, String img_profile, String password, String date_birth):super(id, first_name, last_name, email, tel_number, img_profile, password, date_birth);
