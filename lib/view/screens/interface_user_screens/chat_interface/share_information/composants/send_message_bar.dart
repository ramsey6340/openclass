  ...
  Widget build(BuildContext context)
  {
    return MessageBar(
      onSend: (new_message) {
        ...
        final docRef = db.collection("informations").doc();
        final information = Information(
          docRef.id,
          current_salle.id_salle,
          '${current_user.first_name} ${current_user.last_name}',
          current_classroom.id_classroom,
          content_info: new_message,
          publication_date: DateTime.now().toString(),
          name_classroom: current_classroom.name_classroom,
        );
        create.creationMessage(message);
        create.creationInformation(information);
      },
